                                ...
                                <div class="portlet light portlet-fit bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-red sbold uppercase">View Staff</span>
                                        </div>
                                        ...
                                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                             ...
                                             <%
                                                                try {
                                                                    Connection c=com.dbconnection.Loadconnection.getConnection();
                                                                     PreparedStatement ps = c.prepareStatement("select * from receptionentry");
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> <%=rs.getString("pregno") %> </td>
                                                    <td> <%=rs.getString("dof") %></td>
                                                    <td> <%=rs.getString("location") %></td>
                                                    <td> <%=rs.getString("phone") %></td>
                                                    <td> <%=rs.getString("email") %></td>
                                                    <td> <%=rs.getString("consultdate") %></td>
